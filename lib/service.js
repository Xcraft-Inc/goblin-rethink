...
Goblin.registerQuest (goblinName, 'get', function* (quest, table, id, next) {
  return yield run (quest, r.table (table).get (id), next);
});
...
Goblin.registerQuest (goblinName, 'start-on-changes', function* (
  quest,
  table,
  onChangeQuest,
  goblinId,
